...
| **00:30 – 00:55** *(Demo 3 Nhóm Dừng Bất Định)* | Lần lượt bấm: <br>1. **Preset 2 (Mờ ngày)** $\rightarrow$ Ra kết quả Amber: `Không chắc dữ kiện`, câu hỏi: *"Sinh viên xin nghỉ từ ngày nào?"*<br>2. **Preset 3 (>20% vắng)** $\rightarrow$ Ra kết quả Đỏ: `Ngoài chính sách`, câu hỏi: *"Đã vắng 4/15 buổi (26.7%), có xét ngoại lệ cấm thi không?"*<br>3. **Preset 4 (Bảo lưu)** $\rightarrow$ Ra kết quả Tím: `Vượt thẩm quyền`, câu hỏi: *"Thuộc thẩm quyền Trưởng khoa. Chuyển Trưởng khoa phê duyệt?"* | *"Khi phát sinh rủi ro, Agent không suy đoán bừa bãi mà phân định chính xác 3 nhóm dừng bất định: <br>- Nhóm 1: Giấy khám mờ ngày $\rightarrow$ Hỏi bổ sung mốc thời gian.<br>- Nhóm 2: Vắng vượt quá 20% số buổi $\rightarrow$ Hỏi giảng viên có xét đặc biệt cấm thi không.<br>- Nhóm 3: Bảo lưu cả học kỳ $\rightarrow$ Chuyển đúng thẩm quyền Trưởng khoa. Mọi câu hỏi đều chuẩn hóa đúng 1 lượt hành động."* |
...
- Giải thích kiến trúc 2 tầng:
  - **Tầng 1 (Deterministic Rules Engine)**: Tính toán số học chuyên cần ($>20\%$), rà soát mốc ngày y tế, kiểm tra phân cấp thẩm quyền ($\le 6\text{ms}$).
...
- Thao tác chi tiết trên **Verify Harness**:
  1. Thử nghiệm ca thường quy $\rightarrow$ `AUTO_APPROVE` (0% Over-escalation).
  2. Thử nghiệm ca mờ ngày $\rightarrow$ `ESCALATE (Không chắc dữ kiện)`.
  3. Thử nghiệm ca vắng quá 20% ($4/15$ buổi) $\rightarrow$ `ESCALATE (Ngoài chính sách)`.
  4. Thử nghiệm ca bảo lưu cả kỳ $\rightarrow$ `ESCALATE (Vượt thẩm quyền)`.
...
- Quay lại Verify Harness, bấm **Chạy Kiểm Chứng Hàng Loạt (15 Ca)** $\rightarrow$ Đạt 100% Pass.
